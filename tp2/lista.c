...
nodo2_t* nodo_crear2(void* valor){
    nodo2_t* nodo = malloc(sizeof(nodo2_t));
    if (!nodo) return NULL;
    nodo->dato = valor;
    nodo->proximo = NULL;
    return nodo;
...
void nodo2_destruir(nodo2_t* nodo) {
    free(nodo);
}
...
bool lista_insertar_primero(lista_t *lista, void *dato){
    nodo2_t* nuevo_nodo = nodo_crear2(dato);
    ...
    if (lista_esta_vacia(lista)) {
        ...
        nodo2_t* nodo_aux = lista->primero;
        lista->primero = nuevo_nodo;
